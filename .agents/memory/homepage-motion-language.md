---
name: Homepage motion language
description: Durable distinction between one-time reveals and reversible scroll-linked motion on the Turan homepage.
---

Use one-time entrance reveals for small text groups, labels, controls, cards, and metrics; use continuous reversible scroll-linked motion only for major editorial compositions.
